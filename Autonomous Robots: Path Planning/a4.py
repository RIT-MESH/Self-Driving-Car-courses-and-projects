...
class AStarSearch:
    ...
    def get_possible_moves(self):
        ...
        for connection in self.location.connections:
            if connection in self.explored:
            ...
            if connection not in self.explored and connection not in self.explored:
                distance = self.road_distance(self.location, connection)
    ...
    def explore_next_move(self):
        ...
        self.length_depth = self.not_explored.pop(sorted_not_explored[0]) - self.heuristic(sorted_not_explored[0])
